...
BEGIN
   ...
   dbms_output.put_line('IaNb: Expected [FALSE] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.IaNb('A');
   dbms_output.put_line('IaNb: Expected [FALSE] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.IaNb('999');
   dbms_output.put_line('IaNb: Expected [TRUE] Actual ['||str.bool_to_str(l_bool)||']'); 
   ...
   dbms_output.put_line('is_oddb: Expected [NULL] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.is_oddb(0);
   dbms_output.put_line('is_oddb: Expected [FALSE] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.is_oddb(1);
   dbms_output.put_line('is_oddb: Expected [TRUE] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.is_oddb(2);
   dbms_output.put_line('is_oddb: Expected [FALSE] Actual ['||str.bool_to_str(l_bool)||']'); 

   l_bool := num.is_evenb(NULL);
   dbms_output.put_line('is_evenb: Expected [NULL] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.is_evenb(0);
   dbms_output.put_line('is_evenb: Expected [TRUE] Actual ['||str.bool_to_str(l_bool)||']'); 
   l_bool := num.is_evenb(1);
   dbms_output.put_line('is_evenb: Expected [FALSE] Actual ['||str.bool_to_str(l_bool)||']'); 
